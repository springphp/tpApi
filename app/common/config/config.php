...
return [
    ...
    'template'               => [
        ...
        'type'         => 'Think',
        // 模板路径
        'view_path'    => ROOT_PATH . 'public' . DS . 'theme' . DS,
        //模版根目录
        'view_base'    => ROOT_PATH . 'public' . DS . 'theme' . DS,
        'view_theme'   => '',
        // 模板后缀
        'view_suffix'  => 'html',
        // 模板文件名分隔符
    ...
    'auth'                   => [
        ...
        'public'               => [ 'admin' => ['publics.*','index.*','admins.admin_info','admins.admin_password','admins.admin_headimg'], ],//不需要权限验证的控制器或方法
    ],
    ...
    'encrypt_key'               => '89058f0b52bfa039f44896204f876943',
];